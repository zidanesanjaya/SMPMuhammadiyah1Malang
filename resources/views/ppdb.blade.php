...
<head>
    <meta charset="utf-8">
    <title>SMP MUHASA | Leadership School</title>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top p-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <a href="/cermus_list" class="nav-item nav-link" target="_blank">CERITA MUHASA</a>
                <a href="https://ujian.smpmuhasa.sch.id/" class="nav-item nav-link" target="_blank">UJIAN PPDB</a>
                <a href="/register" class="nav-item nav-link">DAFTAR PPDB</a>
                <a href="/login" class="btn btn-primary py-4 px-lg-4 rounded-0 d-lg-block nav-item nav-link">MASUK<i class="fa fa-arrow-right ms-3"></i></a>
            </div>
        </div>
    </nav>
    <!-- Navbar End -->
                        ...
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-8">
                                    ...
                                    <a href="/register" class="btn btn-primary py-sm-3 px-sm-4">JOIN NOW</a>
                                </div>
                        </div>
                    </div>
                </div>
