...
<head>
    ...
    <title>SMP MUHASA - Sekolahnya Calon Pemimpin</title>
...
<header id="header" class="fixed-top">
    ...
    <h1 class="logo me-auto"><a href="/">SMP MUHASA</a></h1>
    ...
    <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
            ...
            <li><a href="/aksimuhasa">AKSI</a></li>
        </ul>
        <i class="bi bi-list mobile-nav-toggle"></i>
    </nav>
    <!-- .navbar -->

    <a href="/ppdb" class="get-started-btn">Daftar Sekarang</a>
    </div>
</header><!-- End Header -->
...
<div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel" style="position: absolute; z-index: 1;" data-interval="100">
    ...
    <div style="position: absolute; z-index: 2;">
        <div class="container position-relative" data-aos="zoom-in" data-aos-delay="100">
            ...
            <a href="/ppdb" class="btn-get-started">Daftar Sekarang</a>
        </div>
    </div>
</section>
<!-- End Hero -->
