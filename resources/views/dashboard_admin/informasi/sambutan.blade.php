...
<div class="container bg-white border p-3">
    <div class="row form-material">
        <div class="col-md-12">
            <form action="{{route('store.sambutan')}}" method="post" enctype="multipart/form-data">
                @csrf
                @method('put')
                ...
                <h6 class="text-muted mt-5">Nama Kepala Sekolah</h6>
                <input type="text" name="nama" class="form-control" value="{{$nama_kepsek}}">
