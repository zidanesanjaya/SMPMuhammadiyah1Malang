...
<html lang="en">
    <head>
        ...
        <title>Login Siswa - SMP MUHAMMADIYAH 1 MALANG</title>
                        ...
                        <div class="col-md-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    @endif
                                    <div class="px-3 pb-3">
                                        <form class="form-horizontal m-t-20 mb-0" method="POST" action="{{ route('login.login_ppdb') }}">
                                        @csrf
                                        ...
                                        <div class="form-group m-t-10 mb-0 row text-center">
                                            <div class="col-sm-12 m-t-20">
                                                <p>Belum Punya Akun? <a href="{{route('register')}}" class="text-muted">Register</a></p>
                                            </div>
                                        </div>
                                    </div>
