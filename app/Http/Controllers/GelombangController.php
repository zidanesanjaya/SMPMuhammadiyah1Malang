...
class GelombangController extends Controller
{
    ...
    public function list_pembayaran_lunas_page(){
        $listpembayaran = DB::select('select * from vw_pembayaran where status_pembayaran collate utf8mb4_unicode_ci = ? ',['Sudah Lunas']);
    ...
    public function list_pembayaran_belum_lunas_page(){
        $listpembayaran = DB::select('select * from vw_pembayaran where status_pembayaran collate utf8mb4_unicode_ci = ? ',['Belum Lunas']);
